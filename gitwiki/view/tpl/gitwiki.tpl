<div class="generic-content-wrapper" {{if $hideEditor}}style="display: none;"{{/if}}>
	...
	<div id="rename-page-form-wrapper" class="section-content-tools-wrapper" style="display:none;">
		<form id="rename-page-form" action="gitwiki/rename/page" method="post" >
...
<script>
	...
	$( "#rename-page-form" ).submit(function( event ) {
		$.post("gitwiki/{{$channel}}/rename/page", 
		{
	...
	$('#wiki-get-history').click(function (ev) {
		$.post("gitwiki/{{$channel}}/history/page", {name: window.wiki_page_name, resource_id: window.wiki_resource_id}, function (data) {
			if (data.success) {
	...
	function wiki_refresh_page_list() {
		...
		$.post("gitwiki/{{$channel}}/get/page/list/", {resource_id: window.wiki_resource_id}, function (data) {
			if (data.success) {
	...
	$('#save-page').click(function (ev) {
		...
		$.post("gitwiki/{{$channel}}/save/page", {
	...
	function wiki_revert_page(commitHash) {
		...
		$.post("gitwiki/{{$channel}}/revert/page", {commitHash: commitHash, name: window.wiki_page_name, resource_id: window.wiki_resource_id}, 
		function (data) {
			if (data.success) {
	...
	function wiki_compare_page(compareCommit) {
		...
		$.post("gitwiki/{{$channel}}/compare/page", {
