 ...
 *     $a->config['piwik']['trackjserror'] = false;  // set to true to enable
 *
...
function piwik_analytics($a,&$b) {
	 ...
	 */
	$a->page['htmlhead'] .= '<link rel="stylesheet"  type="text/css" href="' . z_root() . '/addon/piwik/piwik.css' . '" media="all" />';
	...
	if ($async) {
		...
		if ($trackjserror) $a->page['htmlhead'] .= "_paq.push(['enableJSErrorTracking']);\r\n";
		$a->page['htmlhead'] .= "var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0]; g.type='text/javascript';\r\ng.defer=true; g.async=true; g.src=u+'piwik.js';\r\ns.parentNode.insertBefore(g,s); })();\r\n </script>\r\n<!-- End Piwik Code -->\r\n";
