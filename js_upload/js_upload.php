...
function js_upload_unload() {
	...
	unregister_hook('photo_upload_end',    'addon/js_upload/js_upload.php', 'js_upload_post_end');
}
...
//        }
        ...
        if($this->allowedExtensions && !in_array(strtolower($ext), $this->allowedExtensions)){
			...
			logger('js_upload: invalid extension');
