...
function startpage_settings(&$a,&$s) {
	...
	$sc .= replace_macros(get_markup_template('field_input.tpl'), array(
		'$field'	=> array('startpage', t('Page to load after login'), $page, t('Examples: &quot;apps&quot;, &quot;network?f=&gid=37&quot; (privacy collection) or &quot;channel&quot; or &quot;notifications/system&quot; (leave blank for default network page (grid).'))
	));
